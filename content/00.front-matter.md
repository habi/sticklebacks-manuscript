...
Changes to the submitted version are visualized [here on GitHub](https://github.com/{{manubot.ci_source.repo_slug}}/compare/v1.0...{%- if manubot.ci_source is defined -%}{{manubot.ci_source.commit}}{%- else -%}main{%- endif -%}#files_bucket).
</em></small>
