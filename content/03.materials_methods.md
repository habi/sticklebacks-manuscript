...
We only performed manual touch-ups where the adjacent bones were extremely close together (causing their appearance to be 'stuck' in the final render; this is also an issue with manual segmentation and not exclusive to the approach described below).
