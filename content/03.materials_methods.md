...
As an additional step, a small piece fo the caudal fin was taken from fish collected in the 2024 field season in order to identify the sex of each individual via genotyping.
DNA was extracted from the fin tissue following Meeker et al.2007 ([@doi:10.2144/000112619]) and subsequent PCR genotyping was performed with LRRc61 primers for this purpose following Archambeault et al., 2020 ([@doi:10.1002/evl3.175]).
...
![Landmarking shown on dorsal (a) and ventral surfaces (b).](images/Landmark_Figure_2.png){#fig:landmarks}
